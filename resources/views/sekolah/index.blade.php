            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-bold text-blue-900">Daftar Sekolah</h3>
                        ...
                        <thead class="bg-blue-900 text-white">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">Nama
                                    Sekolah</th>
                                <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">Jenjang
                                    Pendidikan
                                </th>
                                <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">Alamat
                                </th>
                                <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">Yayasan
                                    Induk</th>
