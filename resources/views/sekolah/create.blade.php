                    ...
                    <form action="{{ route('sekolah.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="yayasan_id" id="yayasan_id"
                                ...
                                @foreach ($yayasan as $yayasan)
                                    <option value="{{ $yayasan->id }}">{{ $yayasan->nama_yayasan }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="alamat" id="alamat" rows="3"
                                class="mt-1 block w-full border-gray-300 focus:border-green-500 focus:ring-green-500 rounded-md shadow-sm" required></textarea>
                        </div>
                        ...
                        <div class="flex items-center justify-end">
                            ...
                            <button type="submit"
                                class="bg-blue-900 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded transition duration-150 ease-in-out">
                                Simpan Data
                            </button>
                        </div>
                    </form>
